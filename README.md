...
2. Click "Create Dummy Game" or press Enter to create a dummy game based on that game. Then select the game from the right side and click "Run" or just double click on it.  
